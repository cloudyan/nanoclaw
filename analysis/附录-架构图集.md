...
sequenceDiagram
    ...
    ML->>Router: 6. 路由消息
    Router->>Router: 7. 检查触发条件
- 是否已注册组？<br/>- 是否以 @Andy 开头？

    alt 触发成功
        Router->>Router: 8. 获取对话上下文
(自上次交互后的所有消息)
        ...
        MCP-->>Claude: 12. 工具可用
        Claude->>Claude: 13. 处理消息
- 读取 CLAUDE.md<br/>- 调用工具<br/>- 生成响应
...
graph TB
    ...
    style MSG1 fill:#99ff99,color:#000000
    style MSG2 fill:#ff9999,color:#000000
    style ROUTER fill:#ccffcc,color:#000000
    style AUTH fill:#ccffcc,color:#000000
    style VALIDATOR fill:#ccffcc,color:#000000
    style FILTER fill:#ccffcc,color:#000000
    style CONTAINER fill:#99ccff,color:#000000
    style AGENT fill:#99ccff,color:#000000
    style ALLOWLIST fill:#ffcc99,color:#000000
    style AUTH_STORE fill:#ffcc99,color:#000000
    style SSH fill:#ffcccc,color:#000000
    style GNUPG fill:#ffcccc,color:#000000
    style AWS fill:#ffcccc,color:#000000
```
...
graph TB
    ...
    style A1 fill:#ff9999,color:#000000
    style A2 fill:#ff9999,color:#000000
    style A3 fill:#ff9999,color:#000000
    style A4 fill:#ff9999,color:#000000
    style A5 fill:#ff9999,color:#000000
    style A6 fill:#ff9999,color:#000000
    style D1 fill:#99ff99,color:#000000
    style D2 fill:#99ff99,color:#000000
    style D3 fill:#99ff99,color:#000000
    style D4 fill:#99ff99,color:#000000
    style D5 fill:#99ff99,color:#000000
    style D6 fill:#99ff99,color:#000000
    style AS1 fill:#99ccff,color:#000000
    style AS2 fill:#99ccff,color:#000000
    style AS3 fill:#99ccff,color:#000000
    style AS4 fill:#99ccff,color:#000000
    style AS5 fill:#99ccff,color:#000000
```
...
graph TB
    ...
    style WA fill:#ffcccc,color:#000000
    style AL fill:#ccffcc,color:#000000
    style AE fill:#ccccff,color:#000000
```
...
flowchart TD
    ...
    style Block1 fill:#ffcccc,color:#000000
    style Block2 fill:#ffcccc,color:#000000
    style Block3 fill:#ffcccc,color:#000000
    style Block4 fill:#ffcccc,color:#000000
    style Block5 fill:#ffcccc,color:#000000
    style AllowRO fill:#ccffcc,color:#000000
    style AllowRW fill:#ccffcc,color:#000000
```
