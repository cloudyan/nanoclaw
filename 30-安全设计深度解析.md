...
graph TB
    ...
    style OTHER fill:#ffcccc,color:#000000
    ...
    style ALLOW fill:#ffcc99,color:#000000
    style C1 fill:#99ccff,color:#000000
    style C2 fill:#99ccff,color:#000000
    style C3 fill:#99ccff,color:#000000
```
...
graph TD
    ...
    style INJECTION fill:#ff9999,color:#000000
    style SYMLINK fill:#ff9999,color:#000000
    style CREDENTIAL fill:#ff9999,color:#000000
    style ESCAPE fill:#ff9999,color:#000000
    style M1 fill:#99ff99,color:#000000
    style M2 fill:#99ff99,color:#000000
    style M3 fill:#99ff99,color:#000000
    style M4 fill:#99ff99,color:#000000
    style M5 fill:#99ff99,color:#000000
    style M6 fill:#99ff99,color:#000000
```
